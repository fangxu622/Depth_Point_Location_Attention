...
class ResNet(nn.Module):
    def __init__(self, base_model, out_channel = 2048,fixed_weight=False, dropout_rate=0.0, bayesian = False):
        ...
        self.fc_last = nn.Linear(feat_in, out_channel, bias=True)
        self.fc_position = nn.Linear(out_channel, 3, bias=True)
        self.fc_rotation = nn.Linear(out_channel, 4, bias=True)
